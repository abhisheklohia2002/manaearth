...
const total = selector.reduce((acc,product)=>{
  ...
  return (
    <>
    <Box position={"sticky"} pt={3} width={"auto"}  display={"flex"} justifyContent={"space-evenly"}>
<Box 
...
<Box display={"flex"}  justifyContent={"left"} >
        ...
        <InputRightAddon
          ...
          border="none"
          >
          <Button size="sm" borderLeftRadius={0} bg={"Highlight"} borderRightRadius={3.3} border="1px solid #949494">
            Search
          </Button>
        </InputRightAddon>
      </InputGroup>
    ...
    <Box display={"flex"}>
       ...
       <img style={{width:"auto",height:"60px"}} className="gif" src="https://images.mamaearth.in/vip-desktop-join.gif" alt="gif" />
       
       <Box ref = {btnRef} onClick={onOpen}  cursor={"pointer"} display={"flex"} alignContent={"center"} alignItems={"center"} ml={5} fontSize={"inherit"} fontWeight={"bold"}>
        <BsCart3  size={20} color="blue" fontWeight={"800"}/>
       <span>
       Cart
       </span>
       </Box>
       <Box cursor={"pointer"} display={"flex"} alignContent={"center"} alignItems={"center"} ml={5} fontSize={"inherit"} fontWeight={"bold"}>
    ...
    size={"md"}
      ...
      >
        ...
        <DrawerContent>
          <DrawerCloseButton />
          <DrawerHeader display={"flex"} alignContent={"center"}alignItems={"center"}>
        <BsArrowLeft size={25} color="blue"/>   <span className="pl-4 font-semibold text-blue-400">My Cart</span>
          </DrawerHeader>
        <Divider/>
          ...
          <DrawerBody>
{
  ...
  <>
  <Box paddingLeft={58}>
    <img className="w-60 pl-10" src="https://images.mamaearth.in/wysiwyg/bags2x.png?fit=contain" alt="" />
    <span
    className="font-bold text-center text-xl pl-10">
    Your cart is empty !
    </span>
    <p className="text-xs pt-3 font-serif">
    It's a good day to buy the items you saved for later
    </p>
    <Button bg={"Highlight"} color={"whiteAlpha.700"} marginLeft={20} marginTop={5}>
      Shop Now
    </Button>
    </Box>
      </>
...
<Box>
{selector?.map((e,i)=>(
  <DrawerCart key = {i} id = {e.id} 
  pic = {e.pic} title = {e.title} dec = {e.dec} rate = {e.rate} review = {e.review} price = {e.price} qty = {e.qty}
  />
))}
</Box>
    )
